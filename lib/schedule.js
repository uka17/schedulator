 ...
 * @returns {object} Returns object {"result": string, "error": string} with UTC date and time of nearest next occurrence of scheduleObject in ISO format (e.g. 2019-01-01T01:00:00.000Z) and error messages.
 */ 
module.exports.nextOccurrence = (schedule) => {     
    ...
    /* istanbul ignore if */
    if(!valid)
        return {"result": null, "error": ajv.errorsText(validate.errors)};
