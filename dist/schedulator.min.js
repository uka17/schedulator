...
},{"./resolve":"FmMj","./util":"S6qf","./error_classes":"yAtQ","fast-json-stable-stringify":"3Xb3","../dotjs/validate":"XNwE","fast-deep-equal":"jIGR"}],"wSe+":[function(require,module,exports) {
...
},{}],"n+Uq":[function(require,module,exports) {
...
},{"./ref":"xcTN","./allOf":"jiJK","./anyOf":"Pnof","./comment":"Vdgo","./const":"z0a6","./contains":"0IaH","./dependencies":"BMaw","./enum":"mbmc","./format":"Bkge","./if":"n+Uq","./items":"veNu","./_limit":"QYf9","./_limitItems":"YoMQ","./_limitLength":"9jIs","./_limitProperties":"GAVZ","./multipleOf":"X86S","./not":"WoJe","./oneOf":"Pd/8","./pattern":"hgZn","./properties":"PyFz","./propertyNames":"B9D0","./required":"oRre","./uniqueItems":"Ylu6","./validate":"XNwE"}],"e07p":[function(require,module,exports) {
...
},{"./dotjs/custom":"JvpR","./refs/json-schema-draft-07.json":"iOul"}],"lsXB":[function(require,module,exports) {
...
},{"./compile":"IFqB","./compile/resolve":"FmMj","./cache":"wSe+","./compile/schema_obj":"h0OD","fast-json-stable-stringify":"3Xb3","./compile/formats":"SmGS","./compile/rules":"e07p","./data":"f9Xx","./compile/util":"S6qf","./compile/async":"edJK","./keyword":"f+FQ","./compile/error_classes":"yAtQ","./refs/data.json":"lsXB","./refs/json-schema-draft-07.json":"iOul"}],"SY57":[function(require,module,exports) {
var e=require("ajv");function t(e){return(e<10?"0":"")+e}function o(t,o,r){var n=new e;return r&&r.forEach(function(e){n.addSchema(e)}),n.compile(o)(t)}function r(t,o,r){var n=new e;r&&r.forEach(function(e){n.addSchema(e)});var a=n.compile(o);return a(t),n.errorsText(a.errors)}function n(){return new Date}function a(e){var o;return t((o=e&&e instanceof Date?e:n()).getUTCHours())+":"+t(o.getUTCMinutes())+":"+t(o.getUTCSeconds())}function s(e,t){var o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:0,r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:0,n=arguments.length>4&&void 0!==arguments[4]?arguments[4]:0,a=arguments.length>5&&void 0!==arguments[5]?arguments[5]:0,s=arguments.length>6&&void 0!==arguments[6]?arguments[6]:0,i=u("2000-01-01T00:00:00.000Z");return i.setUTCFullYear(e.getUTCFullYear()+t),i.setUTCMonth(e.getUTCMonth()+o),i.setUTCDate(e.getUTCDate()+r),i.setUTCHours(e.getUTCHours()+n),i.setUTCMinutes(e.getUTCMinutes()+a),i.setUTCSeconds(e.getUTCSeconds()+s),i.setUTCMilliseconds(e.getUTCMilliseconds()),new Date(i)}function u(e){var t=Date.parse(e);return isNaN(t)?null:new Date(t)}module.exports.monthList=["jan","feb","mar","apr","may","jun","jul","aug","sep","oct","nov","dec"],module.exports.weekDayList=["sun","mon","tue","wed","thu","fri","sat"],module.exports.leadZero=t,module.exports.DataVsSchemaResult=o,module.exports.DataVsSchemaErrors=r,module.exports.getDateTime=n,module.exports.getTimefromDateTime=a,module.exports.addDate=s,module.exports.parseDateTime=u;
},{"ajv":"7PQk"}],"hUDc":[function(require,module,exports) {
module.exports={scheduleSchema:{$id:"http://example.com/schedule",oneOf:[{$ref:"#/definitions/oneTime"},{$ref:"#/definitions/daily"},{$ref:"#/definitions/weekly"},{$ref:"#/definitions/monthly"}],definitions:{oneTime:{type:"object",properties:{oneTime:{type:"string",format:"date-time"}},additionalProperties:!1,required:["oneTime"]},daily:{type:"object",properties:{startDateTime:{type:"string",format:"date-time"},endDateTime:{type:"string",format:"date-time"},eachNDay:{type:"integer",minimum:1},dailyFrequency:{$ref:"daily#/"}},additionalProperties:!1,required:["startDateTime","eachNDay","dailyFrequency"]},weekly:{type:"object",properties:{startDateTime:{type:"string",format:"date-time"},endDateTime:{type:"string",format:"date-time"},eachNWeek:{type:"integer",minimum:1},dayOfWeek:{type:"array",uniqueItems:!0,items:{enum:["sun","mon","tue","wed","thu","fri","sat"]},additionalItems:!1},dailyFrequency:{$ref:"daily#/"}},additionalProperties:!1,required:["startDateTime","eachNWeek","dayOfWeek","dailyFrequency"]},monthly:{type:"object",properties:{startDateTime:{type:"string",format:"date-time"},endDateTime:{type:"string",format:"date-time"},month:{type:"array",uniqueItems:!0,items:{enum:["jan","feb","mar","apr","may","jun","jul","aug","sep","oct","nov","dec"]},additionalItems:!1},day:{type:"array",uniqueItems:!0,items:{type:"integer",minimum:1,maximum:31},additionalItems:!1},dailyFrequency:{$ref:"daily#/"}},additionalProperties:!1,required:["startDateTime","month","day","dailyFrequency"]}}},scheduleSchemaDaily:{$id:"http://example.com/daily",oneOf:[{$ref:"#/definitions/once"},{$ref:"#/definitions/every"}],definitions:{once:{type:"object",properties:{occursOnceAt:{type:"string",format:"time"}},additionalProperties:!1,required:["occursOnceAt"]},every:{type:"object",properties:{start:{type:"string",format:"time"},end:{type:"string",format:"time"},occursEvery:{type:"object",properties:{intervalValue:{type:"integer",minimum:1},intervalType:{type:"string",enum:["minute","hour"]}},additionalProperties:!1,required:["intervalValue","intervalType"]}},additionalProperties:!1,required:["start","occursEvery"]}}}};
},{}],"E64j":[function(require,module,exports) {
var e=require("./tools").getDateTime,r=require("./tools").addDate,t=require("./tools").parseDateTime,a=require("./tools").monthList,n=require("./tools").weekDayList,u=require("./models.json"),i=require("ajv"),l=new i;function s(a,n){var u=new Date(n);if(a.dailyFrequency.hasOwnProperty("occursOnceAt")){var i=a.dailyFrequency.occursOnceAt.split(":");return u.setUTCHours(i[0],i[1],i[2]),u>e()&&u>=t(a.startDateTime)?u:null}if(a.dailyFrequency.hasOwnProperty("occursEvery")){var l=a.dailyFrequency.start.split(":");for(u.setUTCHours(l[0],l[1],l[2],0);u<e();)switch(a.dailyFrequency.occursEvery.intervalType){case"minute":u=r(u,0,0,0,0,a.dailyFrequency.occursEvery.intervalValue);break;case"hour":u=r(u,0,0,0,a.dailyFrequency.occursEvery.intervalValue)}if(a.dailyFrequency.hasOwnProperty("end")){var s=a.dailyFrequency.start.split(":"),o=a.dailyFrequency.end.split(":"),c=r(n,0,0,0,s[0],s[1],s[2],0),y=r(n,0,0,0,o[0],o[1],o[2],0);if(c>=y||u>=y)return null}return n.getUTCDate()==u.getUTCDate()?u:null}}function o(e,a){var u=a,i=0;e.dayOfWeek=e.dayOfWeek.sort(function(e,r){return n.indexOf(e)-n.indexOf(r)});for(var l=0;l<e.dayOfWeek.length;l++){var o=n.indexOf(e.dayOfWeek[l]);if(-1!=o){u=r(u,0,0,o-i),i=o;var c=s(e,u);if(c){if(c>t(e.startDateTime))return c;u=c}}}return null}l.addSchema(u.scheduleSchemaDaily),module.exports.nextOccurrence=function(n){var i=l.compile(u.scheduleSchema);if(!i(n))return{result:null,error:l.errorsText(i.errors)};var c=null;if(n.hasOwnProperty("oneTime")){var y=n.oneTime;t(y)>e()&&(c=y)}if(n.hasOwnProperty("eachNDay")){var d=new Date(e().setUTCHours(0,0,0,0)),f=t(n.startDateTime);for(f.setUTCHours(0,0,0,0);f<d;)f=r(f,0,0,n.eachNDay);null==(c=s(n,f))&&((f=r(f,0,0,n.eachNDay)).setUTCHours(0,0,0,0),c=s(n,f))}if(n.hasOwnProperty("eachNWeek")){var v=new Date(t(n.startDateTime));v.setUTCHours(0,0,0,0),v=r(v,0,0,-v.getUTCDay()),v=r(v,0,0,7*(n.eachNWeek-1));for(var h=new Date((new Date).setUTCHours(0,0,0,0)),D=r(h,0,0,-h.getUTCDay());v<D;)v=r(v,0,0,7*n.eachNWeek);var T=o(n,v);for(T&&(v=T);v<t(n.startDateTime)||v<e();)(T=o(n,v=r(v,0,0,7*n.eachNWeek)))&&(v=T);c=v}if(n.hasOwnProperty("month")){var m=new Date(t(n.startDateTime)),q=e();m<q&&(m=q);var O=n.day.sort(function(e,r){return e-r});m.setUTCHours(0,0,0,0);var w=e().getMonth();e:for(var p=0;p<13;p++){if(n.month.includes(a[w]))for(var C=0;C<O.length;C++){m.setMonth(w,O[C]);var U=s(n,m);if(U&&U>e()){c=U;break e}}12==++w&&(w=0,m=r(m,1))}}return n.endDateTime&&c?c>t(n.endDateTime)?{result:null,error:"calculated date-time earlier than endDateTime"}:{result:c,error:null}:null!=c?{result:t(c),error:null}:{result:null,error:"not able to calculate next run date-time"}};
},{"./tools":"SY57","./models.json":"hUDc","ajv":"7PQk"}]},{},["E64j"], null)
//# sourceMappingURL=schedulator.min.js.map